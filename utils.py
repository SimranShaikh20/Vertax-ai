...
<a target='_blank'
  href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/global/5290276557544226816?project=qwiklabs-gcp-02-ee506ee791ec&deploy=true'>
  Vertex AI Studio
...
<ul style="list-style-position: outside; margin-left: 1em;">
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-insuranceunderwritingassi-1-17478038001/source?project=qwiklabs-gcp-02-ee506ee791ec'
    >
      source code editor
  ...
  <li>Go to your
    <a target='_blank'
       href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/global/5290276557544226816?project=qwiklabs-gcp-02-ee506ee791ec'
    >
  ...
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-insuranceunderwritingassi-1-17478038001/security?project=qwiklabs-gcp-02-ee506ee791ec'
    >
      Security settings
