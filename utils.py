...
<a target='_blank'
  href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/global/5362052676605444096?project=qwiklabs-gcp-04-28d5b4d7cb5d&deploy=true'>
  Vertex AI Studio
...
<ul style="list-style-position: outside; margin-left: 1em;">
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-insurancerisksummary-prot-1-17478316580/source?project=qwiklabs-gcp-04-28d5b4d7cb5d'
    >
      source code editor
  ...
  <li>Go to your
    <a target='_blank'
       href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/global/5362052676605444096?project=qwiklabs-gcp-04-28d5b4d7cb5d'
    >
  ...
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-insurancerisksummary-prot-1-17478316580/security?project=qwiklabs-gcp-04-28d5b4d7cb5d'
    >
      Security settings
